...
const (
	...
	SignResponse_SUCCESS SignResponse_Status = 1
...
func (SignResponse_Status) EnumDescriptor() ([]byte, []int) {
	return file_key_manager_proto_rawDescGZIP(), []int{1, 0}
}
...
type SignRequest struct {
	...
	SigningMsg []byte `protobuf:"bytes,2,opt,name=signing_msg,json=signingMsg,proto3" json:"signing_msg,omitempty"`
}
...
func (x *SignRequest) GetSigningMsg() []byte {
	if x != nil {
		return x.SigningMsg
	}
	return nil
...
type SignResponse struct {
	...
	Status    SignResponse_Status `protobuf:"varint,2,opt,name=status,proto3,enum=curie.SignResponse_Status" json:"status,omitempty"`
}
...
var file_key_manager_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x12, 0x05, 0x63, 0x75, 0x72, 0x69, 0x65, 0x22, 0x4d, 0x0a, 0x0b, 0x53, 0x69,
	...
	0x75, 0x62, 0x6c, 0x69, 0x63, 0x4b, 0x65, 0x79, 0x12, 0x1f, 0x0a, 0x0b, 0x73, 0x69, 0x67, 0x6e,
	0x69, 0x6e, 0x67, 0x5f, 0x6d, 0x73, 0x67, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x0a, 0x73,
	0x69, 0x67, 0x6e, 0x69, 0x6e, 0x67, 0x4d, 0x73, 0x67, 0x22, 0x8f, 0x01, 0x0a, 0x0c, 0x53, 0x69,
	...
	0x75, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1a, 0x2e, 0x63, 0x75, 0x72, 0x69, 0x65,
	...
	0x12, 0x09, 0x0a, 0x05, 0x45, 0x52, 0x52, 0x4f, 0x52, 0x10, 0x02, 0x42, 0x14, 0x5a, 0x12, 0x66,
	0x6c, 0x61, 0x67, 0x2d, 0x65, 0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x2f, 0x70, 0x72, 0x6f, 0x74,
...
var file_key_manager_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_key_manager_proto_goTypes = []interface{}{
	(SignResponse_Status)(0), // 0: curie.SignResponse.Status
	(*SignRequest)(nil),      // 1: curie.SignRequest
	(*SignResponse)(nil),     // 2: curie.SignResponse
}
var file_key_manager_proto_depIdxs = []int32{
	0, // 0: curie.SignResponse.status:type_name -> curie.SignResponse.Status
